...
<img align="left" src="https://raw.githubusercontent.com/orhun/orhun/refs/heads/master/assets/ratatui-spin-dark.gif#gh-dark-mode-only" width="360" height="360">

👾 I'm **AStybux**.

❤️ An open-source developer.

🐁 I work on terminal tooling and libraries.

- 🔭 I`m currently working on lua, html, python, c and bash.
- 🌱 I`m currently learning math, ML, biology.
- 👯 I`m looking to collaborate on sophrosha, dabezb4, foxy_chipher, ernela, snusmumriken, nyxthedev, bb_slipers, themakarik, aexxr, elfluck_razor.
- 🤔 I`m need help with lua and bash projects.
- 💬 Ask me about algorithms and features of programming
- 📫 How to reach me: [@vano_devlog](https://t.me/vano_devlog)
- 😄 Pronouns: all(better pimpimpim)
